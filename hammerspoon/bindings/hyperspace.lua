...
if State.IS_WORK_COMPUTER then
  ...
  Modes.HyperSpace:bind('', '5', function() Utils.yabai_msg('space', 'focus 5') end)
  Modes.HyperSpace:bind('', '6', function() Utils.yabai_msg('space', 'focus 6') end)
  Modes.HyperSpace:bind('', '7', function() Utils.yabai_msg('space', 'focus 7') end)
  Modes.HyperSpace:bind('', '8', function() Utils.yabai_msg('space', 'focus 8') end)
